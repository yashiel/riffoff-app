      ...
      <section className="relative flex min-h-[90svh] items-center overflow-hidden">
        ...
        <div className="relative mx-auto w-full max-w-7xl px-6 py-24 sm:px-8 sm:py-32 lg:px-12">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-[12px] font-medium text-white/60 backdrop-blur-sm">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <Link
                href="/events"
                className="group inline-flex items-center gap-2 rounded-[10px] bg-[#FF2D78] px-7 py-3.5 text-[13px] font-bold uppercase tracking-wider text-white shadow-[0_4px_20px_rgba(255,45,120,0.3)] transition-all hover:translate-y-[-2px] hover:shadow-[0_8px_30px_rgba(255,45,120,0.4)]"
              >
                Browse Events
              ...
              <Link
                href="/register"
                className="inline-flex items-center rounded-[10px] border border-white/12 px-6 py-3.5 text-[13px] font-semibold uppercase tracking-wider text-white/60 transition-all hover:border-white/25 hover:text-white"
              >
                Create Account
              </Link>
            </div>
