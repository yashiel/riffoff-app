  ...
  return (
    <div>
      <div className="flex items-center justify-between">
        ...
        <div className="h-10 w-32 animate-pulse rounded-full bg-muted/80" />
      </div>
      ...
      <div className="mt-8 space-y-3">
        {Array.from({ length: 5 }).map((_, i) => (
          ...
          >
            <div className="size-16 shrink-0 animate-pulse rounded-lg bg-muted/80" />
            <div className="flex-1 space-y-2">
              <div className="h-4 w-48 animate-pulse rounded bg-muted/80" />
