      ...
      {(title || subtitle) && (
        <div className="mb-4 flex items-end justify-between">
          <div>
            ...
            {subtitle && <p className="mt-0.5 text-base text-muted-foreground/80">{subtitle}</p>}
          </div>
          {/* Arrow controls */}
          <div className="flex gap-1.5">
            <button
              ...
              className="flex size-8 items-center justify-center rounded-lg border border-border bg-muted/80 text-muted-foreground transition-all hover:bg-muted hover:text-foreground disabled:opacity-20 disabled:hover:bg-transparent disabled:hover:text-muted-foreground"
